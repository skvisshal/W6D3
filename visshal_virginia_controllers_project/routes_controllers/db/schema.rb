...
ActiveRecord::Schema.define(version: 2021_11_11_185721) do
  ...
  create_table "collection_assignments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["collection_id", "artwork_id"], name: "index_collection_assignments_on_collection_id_and_artwork_id", unique: true
  end
